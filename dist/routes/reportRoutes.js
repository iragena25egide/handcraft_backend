...
router.get("/sales", auth_1.verifyToken, (req, res) => reportController.getSalesRevenue(req, res));
router.get("/low-stock", auth_1.verifyToken, (req, res) => reportController.getLowStockProducts(req, res));
